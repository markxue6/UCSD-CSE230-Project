...
module OnePlayerHard (onePlayerHard, Tick, MyT, drawUI, theMap, moveg, initGame) where
import GameLogicHard
import Data.Maybe
import Data.List
import Prelude
...
drawBoard g = withBorderStyle BS.unicodeBold
  $ B.borderWithLabel (withAttr magBg $ str "Connect 4 Hard AI Move Mode")
  $ vBox rows
  where
